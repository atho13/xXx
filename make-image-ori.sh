...
luci-app-mactodong internet-detector internet-detector-mod-modem-restart luci-app-internet-detector luci-app-ipinfo luci-app-eqosplus ookla-speedtest \
luci-app-ttyd luci-app-tinyfm luci-app-ramfree luci-app-poweroffdevice luci-app-lite-watchdog"

...
# script Credit by BobbyUnknown - InsomWrt

cat << EOF
$(printf '\033[1;32m') _____  ____     ___    ___  ___     ___   ___ ___ $(printf '\033[0m')
$(printf '\033[1;33m')|     ||    \   /  _]  /  _]|   \   /   \ |   |   |$(printf '\033[0m')
$(printf '\033[1;34m')|   __j|  D  ) /  [_  /  [_ |    \ /     \| _   _ |$(printf '\033[0m')
$(printf '\033[1;35m')|  l_  |    / 1    _]l    _]|  D  l|  O  ||  \_/  |$(printf '\033[0m')
$(printf '\033[1;36m')|   _] |    \ |   [_ |   [_ |     ||     ||   |   |$(printf '\033[0m')
$(printf '\033[1;37m')|  |   |  |  r|     1|     b|     |e     l|   |   |$(printf '\033[0m')
$(printf '\033[1;31m')l__j   l__j\_jl_____jl_____jl_____j \___/ l___j___j$(printf '\033[0m')
               ✪ Freedom Internet ✪
EOF
cat << EOF
...
# board type
#Buildfirmware="Ribel | Production Date: 2025-11-11"
print_machine() {
    local Machine=""
    local CPU_Info=""
